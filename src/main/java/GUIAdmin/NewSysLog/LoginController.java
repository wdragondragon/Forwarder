...
public class LoginController {
    private static Logger LOG = LoggerFactory.getLogger(cn.zhouyafeng.itchat4j.controller.LoginController.class);
    ...
    public void login(String qrPath) {
        ...
        while (true) {
            for (int count = 0; count < 10; count++) {
                ...
                while (loginService.getUuid() == null) {
                    ...
                    while (loginService.getUuid() == null) {
                        ...
                        win.log("1.1. 获取微信UUID失败，两秒后重新获取");
                ...
                if (loginService.getQR(qrPath)) {
                    ...
                    win.log("2.2. 获取登陆二维码图片失败，系统退出");
                    System.exit(0);
                }
            }
            LOG.info("3. 请扫描二维码图片，并在手机上确认");
            win.log("3. 请扫描二维码图片，并在手机上确认");
            if (!core.isAlive()) {
                loginService.login();
                core.setAlive(true);
                LOG.info(("登陆成功"));
            ...
            win.log("4. 登陆超时，请重新扫描二维码图片");
        }

        LOG.info("5. 登陆成功，微信初始化");
        win.log("5. 登陆成功，微信初始化");
        ...
        win.log(String.format("欢迎回来， %s", core.getNickName()));
